...
// Função para carregar histórico de cuidadores
async function carregarHistoricoCuidador() {
    try {
        const response = await fetch('/api/historico/cuidador');
...
function exibirHistoricoCuidador() {
